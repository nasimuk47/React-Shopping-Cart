        ...
        <div className="flex flex-wrap justify-between items-center mb-8">
          <div className="flex-1 pr-4">
            <input
              ...
              className="w-[500px] bg-gray-50 border border-gray-300 text-gray-800 text-lg rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all duration-300 shadow-md hover:shadow-lg"
            />
          </div>
